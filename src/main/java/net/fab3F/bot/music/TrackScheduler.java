...
public class TrackScheduler {
    ...
    private final MusicHelper musicHelper = Main.bot.getMusicHelper();
    public final Queue<Track> queue = new LinkedList<>();

    public TrackScheduler(long guildId) {
        this.guildId = guildId;
    }

    public void enqueue(Track track) {
        this.musicHelper.getPlayer(guildId).ifPresentOrElse(
                (player) -> {
    ...
    private void startTrack(Track track) {
        this.musicHelper.getLink(guildId).ifPresent(
